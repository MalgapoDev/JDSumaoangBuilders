...
const Projects = () => {
    ...
    return (
        <div id='projects' style={projectBackground}>
                    ...
                    {cardProjects.map((project) => (
                        <div className='project-card' key={project.id} style={projectCard}>
                            <div className='project-content' style={projectContent}>
                                <div className='project-image' style={projectImageContainer}>
            ...
            <div style={{textAlign: 'right', marginTop: '20px'}}>
                <a style={buttonStyle} href='#ViewProject'>See more projects</a>
            </div>
        </div>
    );
}
